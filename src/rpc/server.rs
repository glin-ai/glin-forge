...
impl RpcServer {
    ...
    pub async fn start(network: String) -> Result<Self> {
        ...
        io.add_method("deploy", move |params: Params| {
            ...
            async move {
                let deploy_params: DeployParams = params.parse()
                    .map_err(|e| RpcError::invalid_params(format!("{}", e)))?;

                let result = methods::handle_deploy(deploy_params).await
                    .map_err(|e| RpcError {
        ...
        io.add_method("call", move |params: Params| {
            ...
            async move {
                let call_params: CallParams = params.parse()
                    .map_err(|e| RpcError::invalid_params(format!("{}", e)))?;

                let result = methods::handle_call(call_params).await
                    .map_err(|e| RpcError {
                        code: ErrorCode::InternalError,
                        message: e.to_string(),
                        data: None,
        ...
        io.add_method("query", move |params: Params| {
            ...
            async move {
                let query_params: QueryParams = params.parse()
                    .map_err(|e| RpcError::invalid_params(format!("{}", e)))?;

                let result = methods::handle_query(query_params).await
                    .map_err(|e| RpcError {
                        code: ErrorCode::InternalError,
                        message: e.to_string(),
                        data: None,
        ...
        io.add_method("watch", move |params: Params| {
            ...
            async move {
                let watch_params: WatchParams = params.parse()
                    .map_err(|e| RpcError::invalid_params(format!("{}", e)))?;

                let result = methods::handle_watch(watch_params).await
                    .map_err(|e| RpcError {
                        code: ErrorCode::InternalError,
                        message: e.to_string(),
                        data: None,
        ...
        io.add_method("getBalance", move |params: Params| {
            async move {
                let balance_params: GetBalanceParams = params.parse()
                    .map_err(|e| RpcError::invalid_params(format!("{}", e)))?;

                let result = methods::handle_get_balance(balance_params).await
                    .map_err(|e| RpcError {
                        code: ErrorCode::InternalError,
                        message: e.to_string(),
                        data: None,
        ...
        io.add_method("requestFaucet", move |params: Params| {
            async move {
                let faucet_params: RequestFaucetParams = params.parse()
                    .map_err(|e| RpcError::invalid_params(format!("{}", e)))?;

                let result = methods::handle_request_faucet(faucet_params).await
                    .map_err(|e| RpcError {
                        code: ErrorCode::InternalError,
                        message: e.to_string(),
                        data: None,
        ...
        io.add_method("estimateGas", move |params: Params| {
            async move {
                let gas_params: EstimateGasParams = params.parse()
                    .map_err(|e| RpcError::invalid_params(format!("{}", e)))?;

                let result = methods::handle_estimate_gas(gas_params).await
                    .map_err(|e| RpcError {
                        code: ErrorCode::InternalError,
                        message: e.to_string(),
                        data: None,
        ...
        io.add_method("getBlockNumber", move |params: Params| {
            async move {
                let block_params: GetBlockNumberParams = params.parse()
                    .map_err(|e| RpcError::invalid_params(format!("{}", e)))?;

                let result = methods::handle_get_block_number(block_params).await
                    .map_err(|e| RpcError {
                        code: ErrorCode::InternalError,
                        message: e.to_string(),
                        data: None,
        ...
        io.add_method("getNetworkInfo", move |params: Params| {
            async move {
                let info_params: GetNetworkInfoParams = params.parse()
                    .map_err(|e| RpcError::invalid_params(format!("{}", e)))?;

                let result = methods::handle_get_network_info(info_params).await
                    .map_err(|e| RpcError {
                        code: ErrorCode::InternalError,
                        message: e.to_string(),
                        data: None,
